...
if ($('#coin_sales1').length) {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            labels: ["FY11", "FY12", "FY13", "FY14", "FY15", "FY16", "FY17", "FY18", "FY19", "FY20"],
            datasets: [{
                label: "AUM",
                backgroundColor: "rgba(117, 19, 246, 0.1)",
                borderColor: '#0b76b6',
                data: [7573, 13107, 17517, 24061, 32410, 44229, 60196, 84033, 115888, 147500],
            }]
        },
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#F0B41A',
                data: [0.8, 0.12, 0.19, 0.28, 0.45, 0.28, 0.44, 0.43, 0.63, 0.65],
            }]
        },
        // Configuration options go here
        options: {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#fd9d24',
                fill: true,
                data: [247, 406, 591, 719, 898, 1279, 1837, 2496, 3995, 5264],
            }]
        },
        // Configuration options go here
        options: {
...
if ($('#verview-shart').length) {
    var myConfig = {
        ...
        "scale-x": { //X-Axis
            "labels": ["Mar'12", "Mar'13", "Mar'14", "Mar'15", "Mar'16", "Mar'17", "Mar'18", "Mar'19","Mar'20","Jun'20","Sep'20"],
            "label": {
                "font-size": 14,
                "offset-x": 0,
            },
        ...
        "series": [{
        	"label": "ROA (Return On Assets)",
                "values": [4.2, 4.1, 3.6, 3.3, 3.5, 3.7, 3.9, 4.1, 4.1, 2.8, 2.9],
                "line-color": "#F0B41A",
                /* "dotted" | "dashed" */
            ...
            },
            {
                ...
                "values": [47, 44.6, 46, 45, 43.1, 41.4, 41.8, 35.3, 33.5, 27.9, 27.8],
                "line-color": "#0884D9",
                /* "dotted" | "dashed" */
                "line-width": 5 /* in pixels */ ,
                "marker": { /* Marker object */
