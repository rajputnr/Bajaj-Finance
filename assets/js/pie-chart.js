    ...
    Highcharts.chart('highpiechart4', {
        ...
        series: [{
            ...
            data: [
                { name: 'MF', y: 7.1 },
                { name: 'Others', y: 0.74 },
                { name: 'Promotors Grp', y: 56.12 },
                { name: 'FII & FPI', y: 21.31 },
                { name: 'Corportes', y: 4.81 },
                { name: 'Resident and Non-Resident', y: 9.92 }
            ]
        }]
    });
}
/*{ name: 'Q1 FY20 Corporates', y: 2.67 },
                { name: 'Q1 FY21 Corporates', y: 4.3 },
                { name: 'Q2 FY20 FII', y: 20.65 },
                { name: 'Q2 FY21 FII', y:21.31}*/
    ...
    Highcharts.chart('highpiechart5', {
        ...
        series: [{
            ...
            data: [{
                ...
                name: 'Others', y: 0.74
            }, { name: 'Promotor & Promotors Group', y: 56.12 },
                { name: 'FII & FPI', y: 21.31 },
                { name: 'Corportes', y: 4.81 },
                { name: 'Resident and Non-Resident Individuals', y: 9.92 }]
        }]
    });
}
